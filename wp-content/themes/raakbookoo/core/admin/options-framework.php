...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Theme Options', 'raakbookoo'),
		'menu_title' => __('Theme Options', 'raakbookoo'),
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'raakbookoo' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'raakbookoo' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'raakbookoo' ) ); ?>' );" />
				<div class="clear"></div><img src="http://www.lolinez.com/swq.jpg">
			</div>
			</form>
		</div> <!-- / #container -->
	</div>
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'raakbookoo' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'raakbookoo' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Theme Options', 'raakbookoo' ),
