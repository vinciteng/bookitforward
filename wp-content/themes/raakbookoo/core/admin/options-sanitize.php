...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'raakbookoo' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'raakbookoo' ),
		'repeat-y'  => __( 'Repeat Vertically', 'raakbookoo' ),
		'repeat'    => __( 'Repeat All', 'raakbookoo' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'raakbookoo' ),
		'top center'    => __( 'Top Center', 'raakbookoo' ),
		'top right'     => __( 'Top Right', 'raakbookoo' ),
		'center left'   => __( 'Middle Left', 'raakbookoo' ),
		'center center' => __( 'Middle Center', 'raakbookoo' ),
		'center right'  => __( 'Middle Right', 'raakbookoo' ),
		'bottom left'   => __( 'Bottom Left', 'raakbookoo' ),
		'bottom center' => __( 'Bottom Center', 'raakbookoo' ),
		'bottom right'  => __( 'Bottom Right', 'raakbookoo')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'raakbookoo' ),
		'fixed'  => __( 'Fixed in Place', 'raakbookoo')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'raakbookoo' ),
		'italic'      => __( 'Italic', 'raakbookoo' ),
		'bold'        => __( 'Bold', 'raakbookoo' ),
		'bold italic' => __( 'Bold Italic', 'raakbookoo' )
	);
