...
function weblizar_admin_enqueue_script() {		
	...
	wp_enqueue_script('snowfall', WL_TEMPLATE_DIR_URI .'/core/theme-options/js/snowstorm.js');
...
function weblizar_option_panal_function() { ?>	
	<div class="wrap" id="weblizar_wrap" >
		<div class="wbl-notify" id="wbl-notify">
			...
			<div class="col-md-4 col-sm-6">
					<h1 style="text-decoration:underline;margin-bottom:40px;"><?php _e('Weblizar Premium','weblizar'); ?></h1>
					<a href="http://weblizar.com/themes/weblizar-premium-theme/" target="blank" class="btn btn-success btn-lg"><?php _e('View Weblizar Premium','weblizar'); ?> </a>
					<a href="http://weblizar.com/themes/weblizar-premium-theme/" target="_blank" class="btn btn-danger btn-lg" ><?php _e('Upgrade to Weblizar Premium','weblizar'); ?></a>
			</div>
		</div>
		</div>
