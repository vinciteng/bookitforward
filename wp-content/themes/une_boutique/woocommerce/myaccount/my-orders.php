	...
	<table class="shop_table my_account_orders">
		...
		<thead>
			<tr>
				...
				<th data-hide="phone" class="order-date"><span class="nobr"><?php _e( 'Date', 'woocommerce' ); ?></span></th>
				<th class="order-status"><span class="nobr"><?php _e( 'Status', 'woocommerce' ); ?></span></th>
				<th data-hide="phone" class="order-total"><span class="nobr"><?php _e( 'Total', 'woocommerce' ); ?></span></th>
				<th data-hide="phone" class="order-actions">&nbsp;</th>
			</tr>
		</thead>
