...
<div class="customer_details col2-set">
	<div class="col-1">
		<?php
			if ($order->billing_email) echo '<strong>'.__( 'Email:', 'woocommerce' ).'</strong><br /><span>'.$order->billing_email.'</span>';
		?>
	</div>
	<div class="col-2">
		<?php
			if ($order->billing_phone) echo '<strong>'.__( 'Telephone:', 'woocommerce' ).'</strong><br /><span>'.$order->billing_phone.'</span>';
		?>
	</div>
</div>
