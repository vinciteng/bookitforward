...
//		if (!wp_verify_nonce($nonce, 'edit-aioseop-nonce')) die ( 'Security Check - If you receive this in error, log out and back in to WordPress');
	...
	function admin_menu(){
		...
		add_menu_page('The Church SEO settings','SEO Options','manage_options','admin.php?page=seo_settings', array($this, 'options_panel'), CP_PATH_URL. '/framework/images/seo-icon.png');
	}
