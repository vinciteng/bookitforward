<?php
	...
	*/
	...
	$price_table_meta_boxes = array(
		"Price Tag" => array(
			'title'=>__('Price Tag','crunchpress'),
			'name'=>'price-table-price-tag',
			'type'=>'inputtext'),
		"Button Link" => array(
			'title'=> __('BUTTON LINK TO URL', 'crunchpress'),
			'name'=>'price-table-option-url',
			'type'=>'inputtext'),
		"Best Price" => array(
			'title'=>__('BEST PRICE','crunchpress'),
	...
	function add_price_table_option(){	
		...
		add_meta_box('price-table-option', __('Price Table Option','crunchpress'), 'add_price_table_option_element',
