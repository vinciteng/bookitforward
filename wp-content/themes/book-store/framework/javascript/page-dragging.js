...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Column','Contact-Form','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/3','element1-3',1/3,['Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/2','element1-2',1/2,['Donation-Widget','Contact-Form','Column','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item','Product-Onsale']],
		['2/3','element2-3',2/3,['Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['3/4','element3-4',3/4,['Column','Contact-Form','Content','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Message-Box','Toggle-Box','Services-Widget','Price-Item']],
		['1/1','element1-1',1,['Widget','Column','Content','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Services-Widget','Text-Widget','Contact-Form','Price-Item','Product-Onsale']]
	];
